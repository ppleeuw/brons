...
const nl: Site = {
  ...
  home: {
    ...
    demo: {
      ...
      sampleLabel: "Voorbeeldgesprek · openingstijden en een afspraak verzetten",
      ...
      transcript: [
        { who: "agent", at: 0, text: "Hoi, ik ben Julia, de digitale assistent van Nekaf. Dit gesprek kan worden opgenomen. Waarmee kan ik je helpen?" },

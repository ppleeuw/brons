/** Content model for the Nekaf site. One object per language, same shape. */
...
export type StepsSection = { title: string; lede: string; steps: { mock: string; title: string; text: string }[]; stat?: { value: string; label: string } };

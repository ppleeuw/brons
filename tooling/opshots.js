...
const TMP = process.env.MEDIA_TMP || require('os').tmpdir() + '/nekaf-media';
...
(async () => {
  ...
  for (const p of pages) {
    ...
    await page.goto((process.env.ORIGIN || 'http://localhost:3100') + p, { waitUntil: 'load', timeout: 120000 }); await page.waitForTimeout(1500);

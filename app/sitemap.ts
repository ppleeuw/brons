...
const STATIC = ["", "product", "product/console", "product/ask-nekaf", "product/agents", "product/integrations", "pricing", "specialties", "customers", "about", "resources", "careers", "safety-compliance", "cookies"];

...
export default function VoiceWave({ caption = "[Agent]: your parts order is on its way", accent = "#4584c6", bars = 30, className = "" }: { caption?: string; accent?: string; bars?: number; className?: string }) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[11px] text-gray-350">Nekaf agent</span>
          </div>
        </div>

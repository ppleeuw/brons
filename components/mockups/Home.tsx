 ...
 * workshop content and a slightly different shape language (larger asymmetric radii, squircle icons,
...
const Wrench = ({ className = "h-5 w-5" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
    <path d="M10.3 2.8v3.7h3.4V2.8a4.5 4.5 0 0 1 0 8.4v8.3a1.7 1.7 0 0 1-3.4 0v-8.3a4.5 4.5 0 0 1 0-8.4Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" transform="rotate(45 12 12)" />
  </svg>
);
...
/** Agent glyph: wrench inside a squircle (stands in for the source's ghost symbol). */
...
export function GwBuild() {
  const steps = [["Updating agent", "View changes", true], ["Researching parts catalog", "", true], ["Creating tests", "", true], ["Running tests", "", false]] as const;
  return (
    <Tile>
      <Panel className="top-[50px] left-[50px] w-[600px] pb-[28px]">
        ...
        <div className="px-[26px] pt-[24px]">
          <div className="rounded-[20px] rounded-tr-[6px] border border-[#d6e6f7] bg-[#eaf3fc] px-[18px] py-[16px]">
            <div className="text-[16px] leading-[22px] text-blue-700">Create a service desk agent for Ridgeline Auto Care to book jobs</div>
          ...
          <p className="mt-[24px] whitespace-nowrap text-[16px] leading-[24px] text-gray-400">
            Using <span className="inline-flex items-center gap-1 text-blue-700"><Nodes className="h-4 w-4" />Journey generation</span>, <span className="inline-flex items-center gap-1 text-blue-700"><Bolt className="h-4 w-4" />Tool generation</span>, and <span className="inline-flex items-center gap-1 text-blue-700"><Db className="h-4 w-4" />Planner lookup</span> to cover services and service plans
          </p>
          <p className="mt-[4px] whitespace-nowrap text-[16px] leading-[24px] text-gray-400">The agent is built. I’m running the workshop validation/deploy step so it can catch planner issues</p>
...
export function GwOptimize() {
  const items = ["Build calm support for breakdown calls, warranty disputes, and refunds.", "Add secure quote approval for brake and tire jobs on the call.", "Implement all three recommendations to strengthen the booking experience."];
  return (
    <Tile>
  ...
  return (
    <Tile>
      <Panel className="top-[50px] left-[50px] w-[640px] px-[50px] pt-[52px] pb-[50px]">
        <div className="text-[27px] leading-[36px] text-gray-700">“Why are conversations being transferred to technicians?”</div>
        <div className="mt-[52px] text-[21px] text-gray-400">Conversation highlights</div>
        <p className="mt-[24px] text-[21px] leading-[32px] text-gray-700">Out of the 118k total conversations, here are the top reasons why conversations have been transferred to technicians:</p>
        <div className="mt-[34px] inline-flex items-center gap-[12px] rounded-[18px] rounded-tl-[6px] bg-white px-[34px] py-[20px] text-[21px] text-gray-700 ring-1 ring-[#d9e8f6]"><span className="h-[10px] w-[10px] rounded-full bg-orange-600" />Quote expired</div>
      </Panel>
      <RightFade />
    </Tile>
  );
  ...
  return (
    <Tile>
      ...
      <Panel className="top-[55px] left-[175px] h-[330px] w-[330px] rounded-[26px] rounded-tl-[10px] px-[30px] pt-[30px]">
        <div className="text-[21px] text-gray-700">Happy customers</div>
  ...
  return (
    <Tile>
      ...
      <Panel className="top-[90px] left-[85px] w-[420px] rounded-[28px] rounded-tl-[28px] rounded-bl-[8px] px-[34px] pt-[30px] pb-[32px]">
        ...
        <div className="mt-[16px] text-[26px] leading-[36px] text-gray-700">Hey Sarah, how can I help with your car?</div>
      </Panel>
      <Panel className="top-[276px] left-[85px] w-[420px] rounded-[28px] rounded-tl-[8px] px-[34px] pt-[30px] pb-[32px]">
        <div className="flex items-center gap-[10px] text-[19px] text-gray-400"><Sparkle className="h-[18px] w-[18px]" color="#716f6c" />Agent</div>
        <div className="mt-[16px] text-[26px] leading-[36px] text-gray-700">Hello Sarah, how is the car running this evening?</div>
      </Panel>
    </Tile>
  );
}
...
export function InsObservability() {
  const groups = [
    { icon: <Wrench className="h-[22px] w-[22px]" />, name: "Supervisors", items: ["Quote validity", "Parts availability"] },
    { icon: <Nodes className="h-[22px] w-[22px]" />, name: "Decisions", items: ["Journey: Service booking"] },
  ...
  return (
    <Tile>
      <Panel className="top-[50px] left-[55px] h-[600px] w-[620px] px-[48px] pt-[42px]">
        <div className="whitespace-nowrap text-[24px] text-gray-700">Book before the inspection lapses</div>
        <div className="mt-[26px] flex flex-col gap-[20px]">
          <div className="w-[520px] rounded-[26px] rounded-tl-[8px] px-[34px] py-[26px] ring-1 ring-[#dbe8f4]">
            <div className="flex items-center gap-[12px] whitespace-nowrap text-[21px]"><Bolt className="h-[20px] w-[20px] text-blue-700" /><span className="text-blue-700">Start Signals</span><span className="ml-[10px] text-gray-350">Inspection due soon</span></div>
            <div className="mt-[14px] inline-flex items-center gap-[10px] whitespace-nowrap rounded-full bg-[#eaf3fc] px-[18px] py-[8px] text-[21px] text-blue-700"><span className="h-2 w-2 rounded-full bg-blue-600" />Insight · Loyal customer, 6 visits</div>
          </div>
          <div className="w-[520px] rounded-[26px] rounded-tl-[8px] px-[34px] py-[26px] ring-1 ring-[#dbe8f4]">
            <div className="flex items-center gap-[12px] whitespace-nowrap text-[21px]"><Nodes className="h-[20px] w-[20px] text-blue-700" /><span className="text-blue-700">Decision</span><span className="ml-[10px] text-gray-350">Eligible for a reminder</span></div>
            <div className="mt-[14px] inline-flex items-center gap-[10px] whitespace-nowrap rounded-full bg-[#eaf3fc] px-[18px] py-[8px] text-[21px] text-blue-700"><span className="h-2 w-2 rounded-full bg-blue-600" />Recommended · Offer slot + 15% off</div>
          </div>
        </div>
      </Panel>
      <RightFade w="30%" />
...
/** Customer context: the memory hub connected to workshop systems. */
export function HzContext() {
  const nodes: [string, number, number, ReactNode][] = [
    ["DMS", 130, 130, <svg key="a" viewBox="0 0 24 24" fill="none" className="h-[38px] w-[38px]"><path d="M7 3h7l4 4v14H7V3Z" stroke="#4584c6" strokeWidth="1.8" strokeLinejoin="round" /><path d="M14 3v4h4M10.5 13h5M13 10.5v5" stroke="#4584c6" strokeWidth="1.8" strokeLinecap="round" /></svg>],
    ["Parts", 382, 115, <svg key="b" viewBox="0 0 24 24" fill="none" className="h-[38px] w-[38px]"><circle cx="12" cy="12" r="8" stroke="#4faf62" strokeWidth="1.8" /><circle cx="12" cy="12" r="3.5" fill="#4faf62" /><path d="M12 4v3M12 17v3M4 12h3M17 12h3" stroke="#4faf62" strokeWidth="1.8" strokeLinecap="round" /></svg>],
    ["Insurer", 470, 290, <svg key="c" viewBox="0 0 24 24" fill="none" className="h-[38px] w-[38px]"><path d="M12 3 4.5 6v6c0 4.5 3.2 7.6 7.5 9 4.3-1.4 7.5-4.5 7.5-9V6L12 3Z" stroke="#7644a6" strokeWidth="1.8" strokeLinejoin="round" /><path d="M9 12l2 2 4-4" stroke="#7644a6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>],
    ...
    <Tile>
      <Panel className="top-[70px] left-[80px] w-[560px] rounded-[30px] rounded-tl-[10px] px-[36px] pt-[32px] pb-[34px]">
        ...
        <ul className="mt-[14px] flex flex-col gap-[8px] pl-[38px] text-[23px] text-gray-400">
          <li className="flex items-center gap-[12px] whitespace-nowrap"><span className="h-[6px] w-[6px] rounded-full bg-gray-300" />Had the brakes done in March</li>
          <li className="flex items-center gap-[12px] whitespace-nowrap"><span className="h-[6px] w-[6px] rounded-full bg-gray-300" />Frequent tire purchases</li>
        </ul>
        <div className="mt-[30px] flex items-center gap-[12px] text-[23px] text-blue-700"><Flag className="h-[22px] w-[22px]" />Decisioning</div>
        <div className="mt-[10px] whitespace-nowrap pl-[38px] text-[23px] text-gray-400">Looking for a service add-on…</div>
      </Panel>
      <svg viewBox="0 0 560 560" className="absolute inset-0 h-full w-full" aria-hidden="true">
      ...
      <Panel className="top-[380px] left-[205px] h-[220px] w-[500px] rounded-[30px] rounded-tl-[10px] px-[36px] pt-[30px]">
        ...
        <div className="mt-[14px] whitespace-nowrap text-[23px] text-gray-400">Would you like a wheel alignment with the tire change?</div>
      </Panel>
      <RightFade w="26%" />
    </Tile>
  );
...
export function HzProactive() {
  const steps = [
    { icon: <Sparkle className="h-[18px] w-[18px]" color="#345eb2" />, label: "SIGNAL", text: "Inspection expires in 14 days", top: 52 },
    { icon: <Code className="h-[18px] w-[18px] text-blue-700" />, label: "API", text: "Check bay availability", top: 216 },
    { icon: <Chat className="h-[18px] w-[18px] text-blue-700" />, label: "Web chat", text: "Confirm inspection", top: 380 },
  ];
  return (
    <Tile>
      <svg viewBox="0 0 560 560" className="absolute inset-0 h-full w-full" aria-hidden="true">

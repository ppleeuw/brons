        ...
        <div className="relative z-10 -mt-10 overflow-clip bg-transparent mask-b-from-90% pt-10">
          <div className="mx-auto w-full max-w-[1160px] px-container-margin">
            <div className="relative" ref={dashRef}>
              <div className="aspect-[4/5] w-full md:aspect-[2144/1228]" style={{ opacity: dashIn ? 1 : 0, transform: dashIn ? "none" : "scale(0.95)", transition: `opacity .7s ${ease}, transform .7s ${ease}` }} role="img" aria-label="Nekaf console">
                <DashboardShell />
              </div>
